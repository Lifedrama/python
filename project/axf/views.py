...
def market(request,categoryid,cid,sortid):
    ...
    return render(request,'axf/market.html',{"title":"闪购超市","leftSlider":leftSlider,"productList":productList,"childList":childList,"categoryid":categoryid,"cid":cid,})
...
def checkuserid(request):
    ...
    try:
        ...
        return JsonResponse({"data":"用户已经被注册","status":"error"})
    except User.DoesNotExist as e:
